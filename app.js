...
async function generateWorkbook() {
  ...
  try {
    ...
    setStatus("Weekly_Inspections row generated successfully using the exact template columns only.", "success");
  } catch (err) {
    console.error(err);
