...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  $("#cluster").addEventListener("change",()=>{applySmartDefaults(); updateDerived();}); r.readAsDataURL(f)};
  ...
  if($("#updateBtn")) $("#updateBtn").onclick=updateExcel; if($("#copyBtn")) $("#copyBtn").onclick=copyDataForExcel;
